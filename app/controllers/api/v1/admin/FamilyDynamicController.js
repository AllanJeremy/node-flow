        ...
        if (!response) {
          FamilyDynamic.create({
            ...
            .then((response) => {
              return ResponseHandler.success(
                res,
                responseLanguage.family_dynamic_store_success,
                CommonTransformer.transform(response)
              );
            })
            .catch((err) => {
          ...
          return ResponseHandler.error(
            res,
            400,
            responseLanguage.family_dynamic_exist
          );
        }
      })
      .catch((err) => {
            ...
            .then((result) => {
              if (response.name != req.body.name) {
                ...
                ElasticsearchEventsHandler.store(
                  ElasticsearchEventsAction.familyDynamicRenamed,
                  data
                );
              }
              ...
              return ResponseHandler.success(
                res,
                responseLanguage.family_dynamic_update_success,
        ...
        if (response) {
          ...
          FamilyDynamic.destroy({ where: { id: req.params.id } })
            .then((response) => {
              ...
              ElasticsearchEventsHandler.store(
                ElasticsearchEventsAction.familyDynamicDelete,
                data
              );

              return ResponseHandler.success(
                res,
                responseLanguage.family_dynamic_delete_success
              );
            })
            .catch((err) => {
              return ResponseHandler.error(res, 500, err.message);
      ...
      .then((response) => {
        UserMetadata.findAll({ where: { family_detail_id: req.body.id } })
          .then((response) => {
              ...
              UserMetadata.update(
                ...
                .then((response) => {
                  FamilyDynamic.findOne({
                    ...
                    ElasticsearchEventsHandler.store(
                      ElasticsearchEventsAction.familyDynamicUpdate,
                      data
                    );
                  });
                })
            ...
            return ResponseHandler.success(
              res,
              responseLanguage.family_dynamic_merge_success
            );
          })
          .catch((err) => {
            return ResponseHandler.error(res, 500, err.message);

        ...
        if (!response) {
          HealthCategory.create({
            ...
            .then((response) => {
              return ResponseHandler.success(
                res,
                responseLanguage.health_category_store_success,
                CommonTransformer.transform(response)
              );
            })
            .catch((err) => {
          ...
          return ResponseHandler.error(
            res,
            400,
            responseLanguage.health_category_exist
          );
        }
      })
      .catch((err) => {
            ...
            .then((result) => {
              if (response.name != req.body.name) {
                ...
                ElasticsearchEventsHandler.store(
                  ElasticsearchEventsAction.healthCategoryRenamed,
                  data
                );
              }
              ...
              return ResponseHandler.success(
                res,
                responseLanguage.health_category_update_success,
        ...
        if (response) {
          ...
          HealthCategory.destroy({ where: { id: req.params.id } })
            .then((response) => {
              ...
              ElasticsearchEventsHandler.store(
                ElasticsearchEventsAction.healthCategoryDelete,
                data
              );

              return ResponseHandler.success(
                res,
                responseLanguage.health_category_delete_success
              );
            })
            .catch((err) => {
              return ResponseHandler.error(res, 500, err.message);
      ...
      .then((response) => {
        UserHealthCategory.findAll({
          ...
          .then((response) => {
                ...
                .then((response) => {
                  UserHealthCategory.findAll({
                    ...
                    if (result && result.length > 0) {
                      let healthCategories = result.map(
            ...
            return ResponseHandler.success(
              res,
              responseLanguage.health_category_merge_success
            );
          })
          .catch((err) => {
            return ResponseHandler.error(res, 500, err.message);

exports.en = {
  admin: {
    ...
    response: {
      ...
      permission_denied:
        "You don't have enough permission to access this module. Please contact administrator.",
      ...
      sexual_orientation_store_success:
        "Sexual orientation created successfully.",
      sexual_orientation_update_success:
        "Sexual orientation updated successfully.",
      sexual_orientation_delete_success:
        "Sexual orientation deleted successfully.",
      ...
      admin_permission_store_success:
        "Admin user permission store successfully.",
      admin_permission_update_success:
        "Admin user permission update successfully.",
      race_merge_success: "Race merged successfully.",
      sexual_orientation_merge_success:
        "Sexual orientation merged successfully.",
      ...
      personality_question_store_success:
        "Personality question created successfully.",
      personality_question_update_success:
        "Personality question updated successfully.",
      personality_question_delete_success:
        "Personality question deleted successfully.",
      personality_question_exist: "Personality question already exists.",
      user_status_change: "User status updated successfully.",
      conversation_starter_store_success:
        "Conversation starter created successfully.",
      conversation_starter_update_success:
        "Conversation starter updated successfully.",
      conversation_starter_delete_success:
        "Conversation starter deleted successfully.",
  ...
  front: {
    validation: {
      ...
      password_alphanumeric:
        "Password must be atleast 8 characters long and alphanumeric.",
      invalid_credentials: "Invalid email address or password.",
      invalid_email: "Email address does not exists.",
      password_confirm_password_match:
      ...
      conversation_starter_id_required:
        "Conversation starter id is a required field.",
      ...
      family_dynamic_status_required:
        "Family dynamic status is a required field.",
      sexual_orientation_status_required:
        "Sexual orientation status is a required field.",
      workouts_status_required: "Health tools status is a required field.",
      health_categories_status_required:
        "Health category status is a required field.",
      ...
      matching_preference_module_required:
        "Matching preference module is a required field.",
    ...
    response: {
      ...
      register_successfully:
        "We have sent you to a verification link to your email address. In order to complete the sign-up process, please click the verification link.",
      not_verified_account:
        "Your email address is not verified. Please verify your email to continue. Click on this link to re-send email.",
      blocked_account:
        "Your account has been suspended by administrator. Please contact support team for more details.",
      mail_not_send: "Something went wrong. Please try again.",
      invalid_code: "Invalid verification code.",
      verified_success: "Verified successfully.",
      reset_password_request_success:
        "We have sent you a link to change the password on email address.",
      ...
      conversation_starter_store_success:
        "Conversation starter saved successfully.",
      ...
      conversation_starter_status_store:
        "Conversation starter status saved successfully.",
      ...
      deactivate_account:
        "You have deactivated your account. Please contact support team for more details.",
      contact_support_store_success:
        "Our contact support team will contact you shortly.",
      ...
      chat_user_store: "Chat user stored successfully.",
    },
  },
  chat: {
    default_message:
      "Welcome! We are Larissa and Kendra, the founders of Joyn. We are so excited to be your first peer match as you connect with the community. Is there anything we can help you with?",
  },
  email: {
    ...
    register: {
      ...
      line2:
        "Your account has been created! Please verify your email using this code:",
    },
    reset_password: {

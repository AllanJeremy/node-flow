...
router.post('/sexual_orientation/edit/:id', [VerifyApiToken, CommonValidation.Validation], sexualOrientation.update);
...
router.post('/health_category/edit/:id', [VerifyApiToken, CommonValidation.Validation], healthCategory.update);

...
db.User.hasMany(db.HealthCategoryUser, {foreignKey: 'user_id', as: 'health_categories'});
db.HealthCategoryUser.belongsTo(db.HealthCategory, {foreignKey: 'health_category_id', as: 'health_category'});
db.User.hasMany(db.WorkoutUser, {foreignKey: 'user_id', as: 'workouts'});
db.WorkoutUser.belongsTo(db.Workout, {foreignKey: 'workout_id', as: 'workout'});

...
db.AdminPermission = require("../models/AdminPermission.js")(
  sequelize,
  Sequelize
);
db.HealthCategory = require("../models/HealthCategory.js")(
  sequelize,
  Sequelize
);
db.Gender = require("../models/Gender.js")(sequelize, Sequelize);
db.SexualOrientation = require("../models/SexualOrientation.js")(
  sequelize,
  Sequelize
);
...
db.UserHealthCategory = require("../models/UserHealthCategory.js")(
  sequelize,
  Sequelize
);
...
db.PersonalityQuestion = require("../models/PersonalityQuestion.js")(
  sequelize,
  Sequelize
);
db.UserPersonalityQuestion = require("../models/UserPersonalityQuestion.js")(
  sequelize,
  Sequelize
);
db.ConversationStarter = require("../models/ConversationStarter.js")(
  sequelize,
  Sequelize
);
db.UserConversationStarter = require("../models/UserConversationStarter.js")(
  sequelize,
  Sequelize
);
...
db.ElasticsearchEvents = require("../models/ElasticsearchEvents.js")(
  sequelize,
  Sequelize
);
db.Avatar = require("../models/Avatar.js")(sequelize, Sequelize);
db.UserRace = require("../models/UserRace.js")(sequelize, Sequelize);
db.UserFamilyDynamic = require("../models/UserFamilyDynamic.js")(
  sequelize,
  Sequelize
);
db.UserMatchingPreference = require("../models/UserMatchingPreference.js")(
  sequelize,
  Sequelize
);
db.ContactSupport = require("../models/ContactSupport.js")(
  sequelize,
  Sequelize
);
...
db.ChatModeration = require("../models/ChatModeration.js")(
  sequelize,
  Sequelize
);
...
db.DeleteChannelMessage = require("../models/DeleteChannelMessage.js")(
  sequelize,
  Sequelize
);
db.ExportChannel = require("../models/ExportChannel.js")(sequelize, Sequelize);
db.UserHealthJourney = require("../models/UserHealthJourney.js")(
  sequelize,
  Sequelize
);
